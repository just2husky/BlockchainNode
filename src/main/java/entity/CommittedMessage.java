...
public class CommittedMessage extends Message {
    ...
    public CommittedMessage() {
    }

    public CommittedMessage(String msgId, String timestamp, String pubKey, String signature,
                            String cliMsgId, String viewId, String seqNum, String ip, int port) {
        super(msgId, Const.CMTDM, timestamp, pubKey, signature);
    ...
    public CommittedMessage(String msgId, String msgType, String timestamp, String pubKey, String signature,
                            String cliMsgId, String viewId, String seqNum, String ip, int port) {
